...
from train_two_stage_copy import train_GANO_HM_two_stage_copy
import random
...
if __name__ == "__main__":
    ...
    with open('config/config_4.yaml', "r") as f:
    ...
    losses_MSE_full, losses_V_MSE_full = train_GANO_HM_two_stage_copy(
