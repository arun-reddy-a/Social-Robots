...
from train_two_stage_copy_copy import train_GANO_HM_two_stage_copy_copy
import random
...
if __name__ == "__main__":
    ...
    with open('config/config_5.yaml', "r") as f:
    ...
    losses_G_transl, losses_MSE_transl, losses_V_MSE_transl, losses_G_poses, losses_MSE_poses,\
    losses_V_MSE_poses, losses_MSE_full, losses_V_MSE_full = train_GANO_HM_two_stage_copy_copy(
