...
from train_two_stage_copy_copy_copy_copy import train_GANO_HM_two_stage_copy_copy_copy_copy
import random
...
if __name__ == "__main__":
    ...
    final_result = train_GANO_HM_two_stage_copy_copy_copy_copy(D_move, D_orient, D_betas, D_hands, D_legs, D_torso,
